...
def main(cfg: DictConfig):
    ...
    if cfg.mode == 'episode_replay':
        ...
        world_model = WorldModel(obs_vocab_size=tokenizer.vocab_size, act_vocab_size=test_env.num_actions, config=instantiate(cfg.world_model), enable_ddcl=tokenizer.enable_ddcl, scale=tokenizer.scale, delta=tokenizer.delta)
