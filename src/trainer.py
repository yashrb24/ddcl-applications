...
class Trainer:
    def __init__(self, cfg: DictConfig) -> None:
        ...
        world_model = WorldModel(obs_vocab_size=tokenizer.vocab_size, act_vocab_size=env.num_actions, config=instantiate(cfg.world_model), scale=tokenizer.scale, delta=tokenizer.delta)
