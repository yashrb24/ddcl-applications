"""
Stage 1: Train DDCL-GAN VAE tokenizer on CIFAR-10 128×128.
...
def main():
    parser = argparse.ArgumentParser(description="Train DDCL-GAN VAE tokenizer (CIFAR-10)")
    parser.add_argument("--image_folder", type=str, required=True)
    parser.add_argument("--results_folder", type=str, default="./results/vae_ddcl_cifar")
